...
const variables = {
	y: {
		// text: this.$t('component-year'),
		// text:"年",
		range: [null, null]
	},
	m: {
		// text: this.$t('component-month'),
		// text:"月",
		range: [1, 12]
	},
	d: {
		// text: this.$t('component-day'),
		// text:"日",
		range: [1, 31]
	},
	h: {
		// text: this.$t('component-hour'),
		// text:"时",
		range: [0, 23]
	},
	i: {
		// text: this.$t('component-minutes'),
		// text:"分",
		range: [0, 59]
	},
	s: {
		// text: this.$t('component-seconds'),
		// text:"秒",
		range: [0, 59]
	}
}
